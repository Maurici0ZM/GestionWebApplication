...
namespace GestionProyectosTareas.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(GestionDBProyectosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Usuario != null ? 
                          ...
                          Problem("Entity set 'GestionDBProyectosContext.Usuario'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GestionDBProyectosContext.Usuario'  is null.");
            }
            var usuario = await _context.Usuario.FindAsync(id);
            if (usuario != null)
            {
